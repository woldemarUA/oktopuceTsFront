// styles.ts
const styles = {
  navContainer: 'bg-teal-600 w-screen',
  flexContainer:
  ...
  logoHeadline: 'text-white rounded-md px-3 py-2 text-lg font-medium',
  navLinks: 'hidden sm:ml-6  sm:block',
  navLink: 'flex space-x-4',
  menuItemActive:
    'bg-teal-600 text-white rounded-md px-3 py-2 text-sm font-medium',
  menuItem:
    'bg-teal-600 hover:bg-teal-500 text-white rounded-md px-3 py-2 text-sm font-medium',
  profileButton:
